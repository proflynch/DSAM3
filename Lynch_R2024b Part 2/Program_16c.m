% Program_16c - The Chapman Cycle. A Stiff System.
% Chapter 16 - Three-Dimensional Autonomous Systems and Chaos.
% Copyright Springer 2023. Stephen Lynch.

% x=[O], y=[0_2], z=[O_3]. Exercise 6 in Section 14.6.
% Simple model of ozone production.
clear
deq=@(t,x) [2*3e-12*x(2)+5.5e-4*x(3)-1.22e-33*x(1)*x(2)*9e17-6.86e-16*x(1)*x(3);...
    5.5e-4*x(3)+2*6.86e-16*x(1)*x(3)-3e-12*x(2)-1.22e-33*x(1)*x(2)*9e17;...
    1.22e-33*9e17*x(1)*x(2)-5.5e-4*x(3)-6.86e-16*x(1)*x(3)]; 
